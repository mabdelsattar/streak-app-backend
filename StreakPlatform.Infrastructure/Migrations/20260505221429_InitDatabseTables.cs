...
{
    /// <inheritdoc />
    public partial class InitDatabseTables : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Streaks_Users_CreatedBy",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_CheckIns_Streaks_StreakId",
                        column: x => x.StreakId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Participants_Streaks_StreakId",
                        column: x => x.StreakId,
                        principalTable: "Streaks",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CheckIns_StreakId_Date",
                table: "CheckIns",
                columns: new[] { "StreakId", "Date" });

            migrationBuilder.CreateIndex(
                name: "IX_CheckIns_UserId_StreakId_Date",
                table: "CheckIns",
                columns: new[] { "UserId", "StreakId", "Date" },
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Participants_UserId_StreakId",
                table: "Participants",
                columns: new[] { "UserId", "StreakId" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_Streaks_CreatedBy",
                table: "Streaks",
                column: "CreatedBy");

            migrationBuilder.CreateIndex(
                name: "IX_Streaks_InviteCode",
                table: "Streaks",
                column: "InviteCode",
                unique: true);
